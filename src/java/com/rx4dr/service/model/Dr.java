...
public class Dr {
    ...
    public Dr(int IDr, String NFirst, String NLast, String NMid, String NNick, String XPh, String XEmail, Integer IUserCreatd, Date TStmpCreatd, Integer IUserUpd, Date TStmpUpd) {
        this.IDr = IDr;
        this.NFirst = NFirst;
        this.NLast = NLast;
        this.NMid = NMid;
